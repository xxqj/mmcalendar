 ...
 * @version 1.0
 * */
public class Tab4LeftFragment extends BasePageFragment implements
		OnItemClickListener {
	...
	public static Fragment newInstance() {
		Tab4LeftFragment fragment = new Tab4LeftFragment();
		return fragment;
	}
	...
	protected void reqRemoteDatas(boolean _isForceFetchData) {
		LogUtil.d(Tab4LeftFragment.this.getClass().getSimpleName(),"加载数据……reqRemoteDatas");
		...
		public void onSuccess(int code, int arg1, int arg2, Object obj) {
			switch (code) {
				case RequestTaskIds.LeftFragment_InfoType_Qry:
					...
					LogUtil.d(Tab4LeftFragment.this.getClass().getSimpleName(),obj.toString());
