 ...
 */
public class Tab5Fragment extends BaseFragment implements View.OnClickListener,RadioGroup.OnCheckedChangeListener
    ...
    protected void findViews(View layoutView) {
        ...
        mAdapter = new CommonPagerAdapter(getChildFragmentManager(), DataProvider.getTab5Frags());
